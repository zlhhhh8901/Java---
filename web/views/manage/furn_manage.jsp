                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td class="product-remove">
                                    <a href="manage/furnServlet?action=queryById&id=${furn.id}&pageNo=${requestScope.page.pageNo}"><i class="icon-pencil"></i></a>
                                    <a class="deleteCSS" href="manage/furnServlet?action=deleteById&id=${furn.id}&pageNo=${requestScope.page.pageNo}"><i class="icon-close"></i></a>
                                </td>
                            </tr>
                            </c:forEach>
                            </tbody>
